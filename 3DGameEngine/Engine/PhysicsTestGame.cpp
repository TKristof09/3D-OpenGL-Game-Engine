...
//	material2->AddVector3("color", Color(0xffb600).ToVector3());
...
//	material3->AddFloat("specularIntensity", 2);
//	material3->AddFloat("specularExponent", 32);
...
//	trigger->GetTransform()->SetScale(math::Vector3(10, 0.5f, 10));
//	//--------------------------------------------------------------------------------------------------------------------------------------
//	//Lights
//	//--------------------------------------------------------------------------------------------------------------------------------------
//	Material* lightMat = new Material();
//	lightMat->AddVector3("color", Color::White.ToVector3());
//	Mesh* lightSphere = new Mesh(".\\res\\arrow.obj");
//	MeshRenderer* lightMeshRenderer = new MeshRenderer(lightSphere, lightMat);
//	dLight->AddComponent(lightMeshRenderer);
