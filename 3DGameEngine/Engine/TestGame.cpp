...
void TestGame::Init()
{
    ...
    sLight->GetTransform()->SetRotation(glm::angleAxis(glm::radians(-60.0f), glm::vec3(1,0,0)));
    ...
    cubeOBJ->GetTransform()->SetRotation(glm::angleAxis(glm::radians(-60.0f), glm::vec3(1, 0, 0)));
